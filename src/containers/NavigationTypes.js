...
class NavigationTypes extends React.Component {
  ...
  moveToMainScreen = () => {
  this.props.appActions.appInitialized();
  }
  ...
  render() {
    return (
      <ScrollView style={styles.container}>
        ...
        <Row title={'Move To Main Screen'} onPress={this.moveToMainScreen}/>
      </ScrollView>
    );
  }
}
...
export default connect(null,mapDispatchToProps)(NavigationTypes);
